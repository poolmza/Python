# Escribir un programa que permita cargar y procesar datos de alumnos 
# del ITU en una lista de tuplas con la siguiente forma: 
# (nombre, dni, materia). Ejemplo: [(“Manuel Juarez”, 19823451, “Matematica”), 
